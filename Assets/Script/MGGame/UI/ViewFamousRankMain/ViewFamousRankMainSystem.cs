...
public static class ViewFamousRankMainSystem
{
    ...
    public static void UITgRuleToggleOnValueChanged(this ViewFamousRankMain self, bool value)
    {
	    ...
	    if (value)
	    {
		    ...
		    self.RefreshContentStar(self.UITop3ContentVerticalLayoutGroup.transform, self.RuleTop3List, weekRewards).Forget();
		    ...
		    self.RefreshContentStar(self.UITop5ContentVerticalLayoutGroup.transform, self.RuleTop5List, totalMileRwds).Forget();
		    ...
		    self.RefreshContentStar(self.UITop10ContentVerticalLayoutGroup.transform, self.RuleTop10List, monthRwds).Forget();
    ...
    public static async UniTask RefreshFamousGrid(this ViewFamousRankMain self)
    {
		...
		YooAssetManager.Instance.LoadSpriteAsync(ResHelper.GetAvatarUrl(Top1PlayerData.AvatarUrl), self.UIHeadIconImage).Forget();
		string frame = RankHelper.GetHallOfFameFrameResByIndex(1);
		YooAssetManager.Instance.LoadSpriteAsync(frame, self.UIHeadFrameImage).Forget();
