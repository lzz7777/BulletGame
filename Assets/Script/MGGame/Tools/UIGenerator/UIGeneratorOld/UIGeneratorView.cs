...
namespace XN
{
    ...
    /// </summary>
    public class UIGeneratorView : UIGeneratorBase
    {
        // 目标生成路径（UI 目录）
        private static string UIPath = Application.dataPath + "\\Script\\MGGame\\UI";
        
        // 代码模板文件所在路径
        private static string TemplatePath = Application.dataPath + "\\Script\\MGGame\\Tools\\UIGenerator\\UIGeneratorTemplate\\UIGeneratorView";

        /// <summary>
        /// 菜单入口：右键或顶部菜单点击生成。
        /// 必须选中一个场景中或 Project 目录下的 GameObject。
        /// </summary>
        [MenuItem("Assets/AutoGen/Create UI View")]
